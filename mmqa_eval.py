...
def mmqa_evaluate(answers, predictions, skip_no_answer=False):
    ...
    for qid, ground_truths in answers.items():
        ...
        prediction = predictions[qid].replace("Answer:", "")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_file', default='MuMuQA/eval/dev.json' , type=str, help='Dataset File')
    parser.add_argument('--prediction_file', default='LLM/LLaMa_output/dev_QPBC_prediction_13B_max500.json',  type=str, help='Prediction File')
    ...
    metrics = mmqa_evaluate(answers, predictions, args.skip_no_answer)
